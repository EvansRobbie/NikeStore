...
const Description = ({ifExist, endpoint:{heading, title, text, btn, url, img}}) => {
  return (
    <div className={` ${ifExist ? 'lg:flex-row-reverse' : 'lg:flex-row' } relative nike-container mx-auto flex flex-col items-center justify-center  lg:justify-between`}>
        ...
        <div className={`${ifExist ? 'rotate-[10deg] hover:rotate-[-10deg]' : 'rotate-[15deg] hover:rotate-[10deg]'} h-full w-[16rem]  sm:w-[450px] md:w-[500px] lg:w-[550px] lg:h-[vh]  py-2  transitions-theme duration-700`}>
