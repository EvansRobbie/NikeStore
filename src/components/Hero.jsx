...
const Hero = ({heroapi: {title, subtitle, img,btntext, videos,sociallinks}}) => {
  ...
  return (
    <div className=' relative  flex w-auto h-auto flex-col'>
        <div className='w-full mx-auto bg-theme clip-path h-[55vh] sm:h-[65vh] md:h-[60vh] lg:h-[85vh] absolute top-0 left-0 opacity-100 z-10'/>
            <div className='relative opacity-100 z-20 flex flex-col items-center justify-center nike-container'>
                <div className='flex items-center justify-center mt-24 sm:mt-28 md:mt-[25] flex-col '>
                    ...
                    <div className='absolute top-[27vh] md:top-[30vh] xl:left-[11%] left-0 grid items-center gap-3 lg:gap-4 justify-items-center duration-700 ease-in  '>
                    {/* social icons */}
                ...
                <div className='flex items-center' >
                    <img className='w-auto h-[20vh] sm:h-[25vh] md:h-[27vh] lg:h-[40vh] xl:h-[43vh] -rotate-[30deg] hover:rotate-0 transitions-theme object-fill ' src={img} alt={title} />
                </div>
            </div>
